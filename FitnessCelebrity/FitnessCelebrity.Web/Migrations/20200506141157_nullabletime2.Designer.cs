...
namespace FitnessCelebrity.Web.Migrations
{
    ...
    [Migration("20200506141157_nullabletime2")]
    partial class nullabletime2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FitnessCelebrity.Web.Models.DailyLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<long>("WorkoutHistoryId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("FitnessCelebrity.Web.Models.FitnessPath", b =>
                {
                    ...
                    b.Property<int>("WorkoutSchedule")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FitnessCelebrity.Web.Models.FitnessPathHistory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("FitnessPathHistories");
                });
            ...
            modelBuilder.Entity("FitnessCelebrity.Web.Models.WorkoutHistory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<long?>("FitnessPathHistoryId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("FitnessPathHistoryId");
            ...
            modelBuilder.Entity("FitnessCelebrity.Web.Models.DailyLog", b =>
                {
                    ...
                    b.HasOne("FitnessCelebrity.Web.Models.WorkoutHistory", "WorkoutHistory")
                        .WithMany("DailyLogs")
            ...
            modelBuilder.Entity("FitnessCelebrity.Web.Models.FitnessPathWorkout", b =>
                {
                    b.HasOne("FitnessCelebrity.Web.Models.ApplicationUser", "CreatedByUser")
                        .WithMany("CreatedFitnessPathWorkouts")
                        .HasForeignKey("CreatedById");
                    ...
                    b.HasOne("FitnessCelebrity.Web.Models.ApplicationUser", "ModifiedByUser")
                        .WithMany("ModifiedFitnessPathWorkouts")
                        .HasForeignKey("ModifiedById");
            ...
            modelBuilder.Entity("FitnessCelebrity.Web.Models.WorkoutHistory", b =>
                {
                    b.HasOne("FitnessCelebrity.Web.Models.FitnessPathHistory", "FitnessPathHistory")
                        .WithMany("WorkoutHistories")
                        .HasForeignKey("FitnessPathHistoryId");
